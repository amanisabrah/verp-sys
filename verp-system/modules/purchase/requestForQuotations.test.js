...
import {general_Edit_Form_Selectors, edit_form_Selctors, contractor_Selectors} from '../../common/selectors';
...
export const RFQ_Edit_Form_Test_Cases = () => {
    ...
    .beforeEach(async t => {
        ...
        await t
            .setTestSpeed(0.5)
            .hover(general_Edit_Form_Selectors.navigate_Bar)
            ...
            .click( general_Edit_Form_Selectors.new_Form.find('[title="New"].menu-button'))//should open new edit form for the RFQ
            .wait(1000)
